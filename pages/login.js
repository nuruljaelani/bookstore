...
const Login = () => {
    return (
        <div className="bg-gray-100">
            <Navbar />
            <div className="flex py-8 md:py-12 lg:py-16 px-2 md:px-10 lg:px-48">
                ...
                <div className="w-full md:w-1/2 px-2 md:px-6">
                    <div className="flex flex-col bg-white rounded shadow border border-gray-200 py-4">
                        <div className="flex px-4 lg:px-8 justify-between items-center mb-4">
                            <p className="text-lg md:text-xl text-gray-800 font-semibold">Login</p>
                            <div className="flex text-xs text-gray-600">
                                Belum punya akun ? 
                                <Link href="/signup" as="/daftar"><a className="text-vermilion-500">Daftar</a></Link>
                            </div>
                        </div>
                        <hr/>
                        <form className="my-6">
